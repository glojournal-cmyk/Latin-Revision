const CACHE='latin-revision-soft-scholar-v7-20260902';
const ASSETS=['./','./index.html','./question-bank.js','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
